...
/****** Object:  Job [dbcc errorlog]    Script Date: 12/26/2019 4:40:32 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 12/26/2019 4:40:33 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [dbcc errorlog]    Script Date: 12/26/2019 4:40:34 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'schedule', 
		...
		@schedule_uid=N'1559c2cc-bedd-4a31-8e04-ac3e27a9ea2e'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
